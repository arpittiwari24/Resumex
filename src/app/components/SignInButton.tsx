...
const SigninButton = () => {
  ...
  return (
    <button onClick={() => signIn()} className="bg-blue-600 text-white py-2 px-6 rounded-full text-lg md:text-xl font-semibold transition duration-300 ease-in-out transform hover:scale-105">
      Sign In
    </button>
  );
};
